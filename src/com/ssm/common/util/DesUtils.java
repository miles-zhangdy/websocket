...
public class DesUtils implements Serializable {
	...
	private static final long serialVersionUID = 3984253886089374903L;
	private static String strDefaultKey = "zhangdayemiyue";// 字符串默认键值
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("加密1后的字符：" + des.encrypt(content));
			String desContent = des.encrypt(des.encrypt(content));
			System.out.println("加密2后的字符：" + desContent);
			System.out.println("解密   后的字符：" + des.decrypt(desContent));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
