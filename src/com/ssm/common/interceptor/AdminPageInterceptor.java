...
/**
 * 
 * ClassName: AdminPageInterceptor 
 * @Description: 后台拦截器
 * @author zhangdaye
 * @date 2016-5-29
 */
public class AdminPageInterceptor implements HandlerInterceptor {
        ...
        if(userVO == null){  
	    	if(excludeURI(url)){  
	    		return true;  
	    			...
	    			builder.append("window.location.href=\""+request.getContextPath()+"/admin/index\";"); 
	...
	private boolean excludeURI(String url){
		...
		return url.contains("admin/index")
			|| url.contains("admin/tologin")
